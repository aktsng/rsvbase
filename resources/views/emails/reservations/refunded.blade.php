...
<body>
    <div class="container">
        ...
        <p>「{{ $facility->name }}」でございます。<br>
            この度は、誠に勝手ながら以下のご予約につきまして、クレジットカードへの返金処理が完了いたしましたのでお知らせいたします。</p>
        ...
        <div class="info-box">
            ...
            <div style="margin-bottom: 8px;">
                ...
                <span class="value" style="color: #e53e3e;">¥{{ number_format($reservation->refunded_amount) }}</span>
            </div>
        </div>

        <p>カード会社により、実際に明細に反映されるまで数日〜数週間かかる場合がございます。<br>
            ご不明な点がございましたら、施設までお問い合わせください。</p>
